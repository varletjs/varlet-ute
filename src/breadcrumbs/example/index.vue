<script setup>
import { Breadcrumbs as VarBreadcrumbs, Breadcrumb as VarBreadcrumb, Icon as VarIcon, Snackbar } from '@varlet/ui'
import '@varlet/ui/es/breadcrumbs/style/index'
import '@varlet/ui/es/breadcrumb/style/index'
